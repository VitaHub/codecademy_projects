...
Track.create(name: "Sherane a.k.a. Master SplinterвЂ™s Daughter", minutes: 5, album_id: a5.id)
...
Track.create(name: "Sing About Me, IвЂ™m Dying of Thirst", minutes: 13, album_id: a5.id)

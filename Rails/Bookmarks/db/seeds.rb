...
b2 = Book.create(title: "Unbroken", author: "Laura Hillenbrand", description: "An Olympic runnerвЂ™s story of survival as a prisoner of the Japanese in World War II after his plane went down over the Pacific.", publisher: "Random House", weeks_on_list: 25, rank_this_week: 2)
b3 = Book.create(title: "Wild", author: "Cheryl Strayed", description: "A womanвЂ™s account of the life-changing 1,100-mile solo hike she took along the Pacific Crest Trail in 1995.", publisher: "Vintage", weeks_on_list: 95, rank_this_week: 3)
...
b6 = Book.create(title: "Outliers", author: "Malcolm Gladwell", description: "Why some people succeed вЂ” it has to do with luck and opportunities as well as talent.", publisher: "Back Bay/Little, Brown", weeks_on_list: 185, rank_this_week: 6)
...
b10 = Book.create(title: "The New Jim Crow", author: "Michelle Alexander", description: "A law professor takes aim at the вЂњwar on drugsвЂќ and its impact on black men.", publisher: "New Press", weeks_on_list: 88, rank_this_week: 10)

Review.create(comment: "[My] favorite book of the year. Chris KyleвЂ™s American Sniper is an amazingly detailed account of fighting in Iraq -- a humanizing, brave story thatвЂ™s extremely readable.", author: "New York Times Book Review", book_id: b1.id)
...
Review.create(comment: "If you imagined a great regatta of books about rowing, then BrownвЂ™s BOYS IN THE BOAT certainly makes the final heatвЂ¦.", author: "Boston Globe", book_id: b4.id)
Review.create(comment: "Cogent historyвЂ¦, and a surprisingly suspenseful tale of triumph.", author: "USA Today", book_id: b4.id)
...
Review.create(comment: "Revealing . . . IвЂ™d recommend this to anyone", author: "USA Today", book_id: b9.id)
Review.create(comment: "HarrisвЂ™s journey of discovery brought back lessons for all of us about our lives, too.", author: "Diane Sawyer", book_id: b9.id)
